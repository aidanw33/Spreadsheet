...
namespace DevelopmentTests
{
    ...
    public class DependencyGraphTest
    {
        ...
        ///Using lots of data with replacement
        ///</summary>
        [TestMethod(), Timeout(2000)] //Timeout(2000)
        [TestCategory("45")]
    ...
    [TestMethod()]
        ...
        [TestMethod]
        public void getDependentsNoDependentsTest()
        {
            DependencyGraph dg = new();
            dg.AddDependency("a", "b");
            dg.AddDependency("a", "c");
            HashSet<string> set = new HashSet<string>(dg.GetDependents("b"));
        ...
        [TestMethod]
        public void hasDependentsAfterRemoved()
        {
            DependencyGraph dg = new();
            dg.AddDependency("a", "b");
            Assert.IsTrue(dg.HasDependents("a"));
        ...
        public void getDependentsTest()
        {
            ...
            dg.AddDependency("a", "b");
            dg.AddDependency("a", "c");
            HashSet<string> set = new HashSet<string>(dg.GetDependents("a"));
        ...
        public void getDependeesTest()
        {
            ...
            dg.AddDependency("a", "b");
            dg.AddDependency("a", "c");
            HashSet<string> set = new HashSet<string>(dg.GetDependees("b"));
